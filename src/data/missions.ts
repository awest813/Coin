...
export const MISSION_TEMPLATES: MissionTemplate[] = [
  ...
  {
    id: 'mission_sky_fortress',
    name: 'The Sky Fortress',
    description: 'A floating citadel from the era of the Sky-Kings has drifted over the Grey Mountains. Investigate the upper decks.',
    tags: ['exploration', 'ruin'],
    difficulty: 15,
    ...
    reward: {
      gold: 400,
      renown: 40,
      possibleItems: ['cloud_silk', 'sky_king_seal', 'thunder_stone'],
    },
    flavorText: {
      success: 'The citadel is a treasure trove of ancient tech. The findings will advance our knowledge by decades.',
      partial: 'We reached the upper decks but the structural integrity failed. We escaped with a few artifacts.',
      failure: 'The fortress began a descent. We had to bail out before reaching the vault.',
    },
  },
  {
    id: 'mission_imperial_shadow',
    name: 'Imperial Shadow',
    description: 'Imperial inquisitors are looking for a dissident hiding in your region. Protect the asset or negotiate a better deal.',
    tags: ['social', 'stealth'],
    difficulty: 16,
    durationLabel: '4 days',
    durationSeconds: 120,
    reward: {
      gold: 600,
      renown: 50,
      possibleItems: ['imperial_coin', 'inquisitor_cloak', 'poison_vial'],
    },
    flavorText: {
      success: 'The inquisitors left frustrated. The asset is safe and grateful. Our influence grows.',
      partial: 'The asset escaped but the inquisitors are suspicious. We had to pay off a few guards.',
      failure: 'The inquisitors found their target. The guild is being watched closely now.',
    },
  },
  {
    id: 'mission_void_leak',
    name: 'Void Leak Suppression',
    description: 'A fissure has opened in the City Below, leaking pure entropy. Seal it before it consumes the sector.',
    tags: ['combat', 'ruin'],
    difficulty: 17,
    ...
    reward: {
      gold: 800,
      renown: 60,
      possibleItems: ['void_shard', 'entropy_core', 'shadow_silk'],
    },
    flavorText: {
