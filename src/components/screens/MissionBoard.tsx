            ...
            {activeMissions.map((am) => {
              ...
              return (
                <motion.div 
                  ...
                  key={am.missionRunId} 
                  className={`premium-card relative overflow-hidden group ${isCampaign ? 'border-rose-600/30' : ''}`}
                >
                  ...
                  >
                    ...
                    {selectedMercIds.length >= 2 && (
                       <motion.div 
                        ...
                        className="p-5 glass-dark border border-white/5 rounded-2xl mb-8"
                       >
                         ...
                         {Object.entries(consumableItems).map(([itemId, qty]) => {
                           ...
                           return (
                             <motion.div 
                              ...
                              className={`glass-dark p-4 rounded-2xl border transition-all cursor-pointer flex items-center gap-4 ${isSelected ? 'border-primary bg-primary/5 shadow-[0_0_15px_rgba(251,191,36,0.1)]' : 'border-white/5 hover:border-white/10'}`}
                             >
